...
{
    public partial class rekartonContext : DbContext
    {
        public rekartonContext()
        {
        }

        public rekartonContext(DbContextOptions<rekartonContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-6E66B9L;Database=rekarton;Trusted_Connection=True;User=seminarski; Password=st123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PacijentOsiguranje>(entity =>
            {
                ...
                entity.Property(e => e.PacijentOsiguranjeId).ValueGeneratedNever();
                ...
                entity.HasOne(d => d.Osiguranje)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_OsiguranjePacijent");
