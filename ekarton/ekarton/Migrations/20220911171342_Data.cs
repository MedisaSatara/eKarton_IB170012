...
namespace ekarton.Migrations
{
    public partial class Data : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DodjeljenDoktors",
                columns: table => new
                {
                    DodjeljenDoktorId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DodjeljenDoktors", x => x.DodjeljenDoktorId);
                    table.ForeignKey(
                        name: "FK_DodjeljenDoktors_Doktor_DoktorId",
                        column: x => x.DoktorId,
                        principalTable: "Doktor",
                        principalColumn: "DoktorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DodjeljenDoktors_Pacijent_PacijentId",
                        column: x => x.PacijentId,
                        principalTable: "Pacijent",
                        principalColumn: "PacijentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1001, "Arijana", "admin", "PMrjcrYtuedM8P3LbG24ooLB7aY=", "9fj9KknDkxyydNu/jPz+pQ==", "Husic" },
                    { 1002, "Medisa", "korisnik", "yLYuAOt4Di8zitr6VSIw4AE2CbE=", "wUcZwkU9yTQTATwSKR70nA==", "Satara" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6001, new DateTime(2022, 9, 18, 19, 13, 39, 949, DateTimeKind.Local).AddTicks(1980), "Panklav", new DateTime(2022, 9, 11, 19, 13, 39, 949, DateTimeKind.Local).AddTicks(1169), "Svako 12 sati", "2 puta na dan" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6100, new DateTime(2022, 9, 13, 19, 13, 39, 949, DateTimeKind.Local).AddTicks(7177), "Posjeta orl doktora", "Upala uha" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 9, 11, 19, 13, 39, 926, DateTimeKind.Local).AddTicks(8084), 1001, 1 },
                    { 2, new DateTime(2022, 9, 11, 19, 13, 39, 936, DateTimeKind.Local).AddTicks(5511), 1002, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5001, "Ne", "14B579", "1998-12-11", "Nema", "Josip", "1211998796541", false, "pacijent1", 1002, "AB", "8x/qobY6Ga+Oq8KGWQJB/I+ccxo=", "aFxdJv9B48K7/LtOFe6a7A==", "Mostar", "Mostar", "Bojcic", "+", "M", "061 201 022" },
                    { 5002, "Antibiotik", "19378A", "1980-05-08", "Nema", "Helena", "5089801236547", false, "Pacijent2", 1002, "A", "yoampmSNnBaQ6HZhYhI+Pzsn/vA=", "aFxdJv9B48K7/LtOFe6a7A==", "Mostar", "Mostar", "Radic", "+", "Z", "062 201 022" },
                    { 5003, "Ne", "8537C", "1992-11-12", "Nema", "Melita", "5089801236547", false, "pacijent3", 1002, "AB", "eyAthJOWVRbilkKlzwTk/A4aduQ=", "aFxdJv9B48K7/LtOFe6a7A==", "Stolac", "Mostar", "Golubica", "-", "Z", "063 991 022" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, new DateTime(2022, 9, 11, 19, 13, 39, 948, DateTimeKind.Local).AddTicks(5061), 4003, 5003, true },
                    { 3, new DateTime(2022, 9, 11, 19, 13, 39, 948, DateTimeKind.Local).AddTicks(3397), 4001, 5001, true },
                    { 4, new DateTime(2022, 9, 11, 19, 13, 39, 948, DateTimeKind.Local).AddTicks(4984), 4002, 5002, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "DodjeljenDoktorId", "DatumOd", "DoktorId", "PacijentId" },
                values: new object[,]
                {
                    { 4, new DateTime(2022, 9, 11, 19, 13, 39, 955, DateTimeKind.Local).AddTicks(5910), 3001, 5001 },
                    { 5, new DateTime(2022, 9, 11, 19, 13, 39, 955, DateTimeKind.Local).AddTicks(7180), 3007, 5002 },
                    { 6, new DateTime(2022, 9, 11, 19, 13, 39, 955, DateTimeKind.Local).AddTicks(7256), 3008, 5003 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3001, 5001, new DateTime(2022, 9, 11, 19, 13, 39, 947, DateTimeKind.Local).AddTicks(8055) },
                    { 3007, 5002, new DateTime(2022, 9, 11, 19, 13, 39, 947, DateTimeKind.Local).AddTicks(9311) },
                    { 3008, 5003, new DateTime(2022, 9, 11, 19, 13, 39, 947, DateTimeKind.Local).AddTicks(9376) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 6110, new DateTime(2022, 9, 11, 19, 13, 39, 950, DateTimeKind.Local).AddTicks(2564), "Upala srednjeg uha", 3001, 5001, "Bol  uhu i glava", 6001, 6100 });

            migrationBuilder.InsertData(
                table: "Termin",
                columns: new[] { "TerminId", "Datum", "DoktorId", "PacijentId", "Razlog", "Vrijeme" },
                values: new object[] { 7110, new DateTime(2022, 9, 11, 19, 13, 39, 951, DateTimeKind.Local).AddTicks(766), 3009, 5001, "rutinska kontrola", "09:15:00" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DodjeljenDoktors_DoktorId",
                table: "DodjeljenDoktors",
                column: "DoktorId");

            migrationBuilder.CreateIndex(
                name: "IX_DodjeljenDoktors_PacijentId",
                table: "DodjeljenDoktors",
                column: "PacijentId");
