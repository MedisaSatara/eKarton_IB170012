...
namespace ekarton.Services
{
    public class KorisnikService:IKorisnikService
    {
        ...
        public KorisnikService(rekartonContext context, IMapper mapper)
        {
            Context = context;
            _mapper = mapper;
        }

        public List<Model.Models.Korisnik> Get(KorisnikSearchRequest search)
        {
        ...
        {
           var entity = _mapper.Map<Databases.Korisnik>(request);
            Context.Add(entity);
        ...
        public async Task<Model.Models.Korisnik>Login(string username, string password)
        {
            ...
            {
                throw new UserException("pogresan usernamse ili password");
            }
            return _mapper.Map<Model.Models.Korisnik>(entity);
        }
